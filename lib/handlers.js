...
// Index
handlers.index = function(data,callback){ // callback(200,str,'html')
...
// Create Account
handlers.accountCreate = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
// Create New Session
handlers.sessionCreate = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
// Edit Your Account
handlers.accountEdit = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
handlers.sessionDeleted = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
handlers.accountDeleted = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
// Create a new check
handlers.checksCreate = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
handlers.checksList = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
// Edit a Check
handlers.checksEdit = function(data,callback){ // callback(200,str,'html')
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
...
handlers.public = function(data,callback){ // callback(200,data,contentType);
  // Reject any request that isn't a GET
  if(data.method == 'get'){
...
// Required data: id of tokenObject, extend
// Optional data: none
